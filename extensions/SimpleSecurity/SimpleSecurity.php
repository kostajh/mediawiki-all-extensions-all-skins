...
if( version_compare( $wgVersion, '1.28.0' ) < 0 ) {
	die( 'This version of SimpleSecurity is for MediaWiki 1.28 or greater, please install SimpleSecurity 4.x which can be found at http://svn.organicdesign.co.nz/listing.php?repname=extensions' );
}
/**
 ...
 *
 * See https://www.mediawiki.org/Extension:SimpleSecurity for installation and usage details
...
$wgAutoloadClasses['LBFactorySimpleSecurity'] = $dir . 'LBFactorySimpleSecurity.php';
$wgAutoloadClasses['LoadBalancerSimpleSecurity'] = $dir . 'LoadBalancerSimpleSecurity.php';
...
$wgExtensionCredits['parserhook'][] = array(
	'path'        => __FILE__,
	'name'        => "SimpleSecurity",
	'author'      => "[https://www.organicdesign.co.nz/User:Nad User:Nad]",
	'url'         => "https://www.mediawiki.org/wiki/Extension:SimpleSecurity",
	'version'     => SIMPLESECURITY_VERSION,
	'descriptionmsg' => 'security-desc',
);
$wgHooks['MessagesPreLoad'][] = 'wfSimpleSecurityMessagesPreLoad';
$wgHooks['ParserFirstCallInit'][] = 'SimpleSecurity::onParserFirstCallInit';
