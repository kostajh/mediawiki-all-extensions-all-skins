...
class SkinOffline extends SkinTemplate {
	...
	function buildContentActionUrls( $content_navigation ) {
		...
		$nskey = $this->getTitle()->getNamespaceKey();
...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="<?php $this->text('lang') ?>" lang="<?php $this->text('lang') ?>" dir="<?php $this->text('dir') ?>">
  <head>
    ...
    <!--[if IE]><script src="<?php $this->text('stylepath') ?>/common/IEFixes.js"></script>
    <meta http-equiv="imagetoolbar" content="no" /><![endif]-->
    <script src="<?php $this->text('stylepath' ) ?>/common/wikibits.js"></script>
    <script src="<?php $this->text('skinpath' ) ?>/md5.js"></script>
    <script src="<?php $this->text('skinpath' ) ?>/utf8.js"></script>
    <script src="<?php $this->text('skinpath' ) ?>/lookup.js"></script>
    <?php if($this->data['jsvarurl'  ]) { ?><script src="<?php           $this->text('jsvarurl'  ) ?>"></script><?php } ?>
    <?php if($this->data['pagecss'   ]) { ?><style type="text/css"><?php $this->html('pagecss'   ) ?></style><?php    } ?>
    <?php if($this->data['usercss'   ]) { ?><style type="text/css"><?php $this->html('usercss'   ) ?></style><?php    } ?>
    <?php if($this->data['userjs'    ]) { ?><script src="<?php           $this->text('userjs'    ) ?>"></script><?php } ?>
    <?php if($this->data['userjsprev']) { ?><script><?php                $this->html('userjsprev') ?></script><?php   } ?>
  </head>
